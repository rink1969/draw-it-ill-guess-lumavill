...
export const dialoguePools = {
  en: {
    ...
    reveal: ["I am not looking at the word. Promise.", "Whatever the word is, it has excellent doodle potential.", "Draw the important clues, but keep the answer hidden from me."],
    memoryTitles: ["Our First Drawing Game", "The Great Cozy Guess", "Kaka's Suspicious Sketch Case", "A Very Important Art Memory"],
    memoryLines: ["Today we played Draw & Guess together.", "Kaka stared at the canvas with heroic seriousness.", "A tiny masterpiece appeared, and Kaka had opinions."],
  },
  zh: {
    ...
    reveal: ["我没有看题目，保证！", "不管题目是什么，一定很适合画出来。", "把关键特征画出来，但别让我直接看到答案。"],
    memoryTitles: ["我们的第一次你画我猜", "温暖猜谜大作战", "Kaka 的神秘画案", "一段重要的绘画记忆"],
    memoryLines: ["今天我们一起玩了你画我猜。", "Kaka 非常认真地盯着画布。", "一幅小小的杰作出现了，Kaka 也有了自己的判断。"],
  },
} as const;
